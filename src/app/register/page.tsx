    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center px-4">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-8 w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">RelationCraft</h1>
          <p className="text-gray-600 dark:text-gray-400">회원가입</p>
        </div>
        ...
        >
          ...
          <span className="font-semibold text-gray-700 dark:text-gray-200">Google로 시작하기</span>
        </button>
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-semibold mb-1 dark:text-gray-300">비밀번호 확인</label>
            <input
              type="password"
